...
class DistributedBaselineTests extends AnyFunSuite with BeforeAndAfterAll {
  ...
  test("Compute global average")                           { assert(within(1.0, 3.543195360857739, 0.0001)) }
  test("Compute user 1 average")                           { assert(within(1.0, 3.821428571428572, 0.0001)) }
  test("Compute item 1 average")                           { assert(within(1.0, 3.9003661486825236, 0.0001)) }
  test("Compute item 1 average deviation")                 { assert(within(1.0, 0.28475833805967765, 0.0001)) }
  test("Compute baseline prediction for user 1 on item 1") { assert(within(1.0, 4.157036612713192, 0.0001)) }
